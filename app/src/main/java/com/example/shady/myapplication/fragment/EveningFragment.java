...
public class EveningFragment extends Fragment implements UpdateInterface {
    FirebaseHelper helper;
    DatabaseReference db;
    ArrayList<MedicInformation>  eveningArray ;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
        View rootView = inflater.inflate(R.layout.fragment_night, container, false);

        //////////////////////////////////////////////////////////////////////////////
        RecyclerView rv = (RecyclerView) rootView.findViewById(R.id.rv_drugs_list);
        adapter= new DataAdapter_ts((AppCompatActivity) getActivity(),eveningArray);
    ...
    public void isTimeWithinInterval(ArrayList<MedicInformation> data) throws Exception {
        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            for (long time : item.getTimelong()) {
               ...
               if (calendar_4.get(Calendar.HOUR_OF_DAY) >= 19 && calendar_4.get(Calendar.HOUR_OF_DAY) < 24) {
