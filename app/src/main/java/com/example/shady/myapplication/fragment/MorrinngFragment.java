...
public class MorrinngFragment extends Fragment implements UpdateInterface {

    FirebaseHelper helper;
    DatabaseReference db;
    ArrayList<MedicInformation> morringArray ;
    ...
    public void isTimeWithinInterval(ArrayList<MedicInformation> data) throws Exception {
        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            for (long time : item.getTimelong()) {
             ...
             if (calendar_4.get(Calendar.HOUR_OF_DAY) >= 7 && calendar_4.get(Calendar.HOUR_OF_DAY) < 12) {
